...
PWM_STEERING_THROTTLE = {
    ...
    "STEERING_RIGHT_PWM": 425,              #pwm value for full right steering
    "THROTTLE_FORWARD_PWM": 250,            #pwm value for max forward throttle
...
THROTTLE_FORWARD_PWM = 345      #pwm value for max forward throttle
THROTTLE_STOPPED_PWM = 355      #pwm value for no movement
THROTTLE_REVERSE_PWM = 370      #pwm value for max reverse throttle
